    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<SeatAndAncillarySelectionPage />}
        />

        <Route
          path="/flight/booking-success"
          element={<FlightBookingSuccessPage />}
        />
        ...
        <Route
          path="/admin/*"
          element={
            <ExternalRedirect to="https://admin.goairclass.com" />
          }
        />
