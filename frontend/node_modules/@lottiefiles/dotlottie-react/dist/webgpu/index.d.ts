import { WebGPUConfig } from "@lottiefiles/dotlottie-web/webgpu";
...
declare const DotLottieReact: ({
  device,
  ...props
}: DotLottieReactProps) => ReactNode;
declare const setWasmUrl: (url: string) => void;
//#endregion
export { DotLottieReact, DotLottieReactProps, type WebGPUConfig, setWasmUrl };
