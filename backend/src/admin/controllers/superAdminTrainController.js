const Train = require('../../legacy/models/train/Train');
const TrainBooking = require('../../legacy/models/train/TrainBooking');
const Station = require('../../legacy/models/train/Station');
