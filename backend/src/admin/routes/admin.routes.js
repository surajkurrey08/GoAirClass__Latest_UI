...
const Route = require('../../legacy/models/Route');
const Booking = require('../../legacy/models/Booking');
const mongoose = require('mongoose');
const { authMiddleware } = require('../../middleware/auth.middleware');
const stationController = require('../controllers/stationController');
const adminDashboardController = require('../controllers/adminDashboardController');
const adminBusController = require('../controllers/adminBusController');
const routeController = require('../../legacy/controllers/routeController');
const adminBookingController = require('../controllers/adminBookingController');
// const { getHotelDashboardStats } = require('../../b2c/hotels/hotel.controller');
