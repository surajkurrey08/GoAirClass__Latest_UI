...
const AdminRequest = require('../../legacy/models/AdminRequest');
const Operator = require('../../legacy/models/Operator');
const Bus = require('../../legacy/models/Bus');
// const HotelOperator = require('../../legacy/models/hotel/HotelOperator');
const OperatorRequest = require('../../legacy/models/OperatorRequest');
const { verifyCaptcha } = require('../../core/utils/captchaService');
const { sendOTP } = require('../../core/notifications/smsService');
